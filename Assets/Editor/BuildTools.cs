...
public class BuildTools : EditorWindow
{
    ...
    void OnGUI()
    {
        ...
        if (GUILayout.Button("Export Windows", GUILayout.Width(200)))
        {
            //  Batchmode.ExportWindowsProject();
        }
    ...
    public static void ProcessBundleName()
    {
        ...
        SetAssetBundleNameAtPath("Assets/BuildOnlyAssets/BaseAssets/UI_Online/", "*.png", SearchOption.AllDirectories);
        SetAssetBundleNameAtPath("Assets/BuildOnlyAssets/BaseAssets/Prefab/", "*.prefab", SearchOption.AllDirectories);
