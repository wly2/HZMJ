    ...
    */
    ...
    private void SetSeat(AvatarVO avatar)
    {
        ...
        if (avatar.account.uuid == GlobalDataScript.loginResponseData.account.uuid)
        {
            ...
            playerItems[0].headerIcon.sprite = GlobalDataScript.weChatInformation.headIcon;
            playerItems[0].nameText.text = GlobalDataScript.weChatInformation.weChatName;
