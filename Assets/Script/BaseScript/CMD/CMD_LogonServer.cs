...
//游客登录
public class CMD_GP_VisitorLogon
{
    public ushort wFaceID; //头像标识
    public byte cbGender; //用户性别
    public uint dwPlazaVersion; //广场版本
    ...
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 32)]
    public byte[] szSpreader; //推广人名

    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 33)]
    public byte[] szPassWord; //登录密码

    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 33)]
    public byte[] szPassWordBank; //登录密码
}
...
public struct CMD_GP_LogonSuccess
{
    ...
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)]
    public byte[] FangkaWeixin; //无用

    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)]
    public byte[] AdviceWeixin; //无用

    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)]
    public byte[] ProxyWeixin; //无用

    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)]
    public byte[] GameWeixin; //公告

    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 256)]
    public byte[] FeedbaceMail; //关于-联系我们全部内容
}
